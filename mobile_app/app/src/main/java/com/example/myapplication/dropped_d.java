...
public class dropped_d extends AppCompatActivity {
    ...
    private void sendOne()
    {
        if (btSocket!=null)
        {
            try
            {
                btSocket.getOutputStream().write("D1".toString().getBytes());
            }
            catch (IOException e)
            {
                msg("Error");
    ...
    private void sendTwo()
    {
        if (btSocket!=null)
        {
            try
            {
                btSocket.getOutputStream().write("D2".toString().getBytes());
            }
            catch (IOException e)
            {
                msg("Error");
    ...
    private void sendThree()
    {
        if (btSocket!=null)
        {
            try
            {
                btSocket.getOutputStream().write("D3".toString().getBytes());
            }
            catch (IOException e)
            {
                msg("Error");
    ...
    private void sendFour()
    {
        if (btSocket!=null)
        {
            try
            {
                btSocket.getOutputStream().write("D4".toString().getBytes());
            }
            catch (IOException e)
            {
                msg("Error");
    ...
    private void sendFive()
    {
        if (btSocket!=null)
        {
            try
            {
                btSocket.getOutputStream().write("D5".toString().getBytes());
            }
            catch (IOException e)
            {
                msg("Error");
    ...
    private void sendSix()
    {
        if (btSocket!=null)
        {
            try
            {
                btSocket.getOutputStream().write("D6".toString().getBytes());
            }
            catch (IOException e)
            {
                msg("Error");
    ...
    */
    ...
    private class ConnectBT extends AsyncTask<Void, Void, Void>  // UI thread
    {
        ...
        {
            progress = ProgressDialog.show(dropped_d.this, "Connecting...", "Please wait!!!");  //show a progress dialog
        }
